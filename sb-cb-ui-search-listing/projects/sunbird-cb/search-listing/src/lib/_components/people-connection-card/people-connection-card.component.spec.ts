...
describe('PeopleConnectionCardComponent', () => {
  ...
  describe('connetToUser', () => {
    ...
    it('should emit connection-updated and show success message on successful connection request', () => {
      // Arrange
      mockNetworkService.createConnection.mockReturnValue(of({}));
      ...
      // Assert
      expect(mockNetworkService.createConnection).toHaveBeenCalledWith({
        connectionId: 'id456',
        userIdFrom: 'user123',
    ...
    it('should show error message on failed connection request', () => {
      // Arrange
      mockNetworkService.createConnection.mockReturnValue(throwError('Error'));
