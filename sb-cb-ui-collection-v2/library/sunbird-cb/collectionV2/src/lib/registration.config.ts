...
import { BtnPageBackV2Component } from './btn-page-back-v2/btn-page-back-v2.component'
...
import { BtnPageBackV2Module } from './btn-page-back-v2/btn-page-back-v2.module'
...
import { LeftMenuV1Module } from './left-menu-v1/left-menu-v1.module'
import { LeftMenuV1Component } from './left-menu-v1/left-menu-v1.component'
...
export const WIDGET_REGISTRATION_CONFIG: NsWidgetResolver.IRegistrationConfig[] = [
  ...
  {
    widgetType: ROOT_WIDGET_CONFIG.actionButton._type,
    widgetSubType: ROOT_WIDGET_CONFIG.actionButton.pageBackV2,
    component: BtnPageBackV2Component,
  },
  {
    widgetType: ROOT_WIDGET_CONFIG.actionButton._type,
    widgetSubType: ROOT_WIDGET_CONFIG.actionButton.pageBack,
  ...
  {
    widgetType: ROOT_WIDGET_CONFIG.menus._type,
    widgetSubType: ROOT_WIDGET_CONFIG.menus.leftMenuV1,
    component: LeftMenuV1Component,
},
{
    widgetType: ROOT_WIDGET_CONFIG.menus._type,
