import { Component, OnInit, Input, OnChanges, SimpleChanges, AfterViewInit, OnDestroy, ViewChild, ElementRef, Inject } from '@angular/core'
...
export class AppTocAboutComponent implements OnInit, OnChanges, AfterViewInit, OnChanges, OnDestroy {
  sectorsList: { sectorId: any; sectorName: any }[] = []
  subSectorsList: { subSectorId: any; subSectorName: any }[] = []
  ...
  getAuthorReply(identifier: string, primaryCategory: any, userIds: any[]) {
    const request = {
      request: {
  ...
  tracker(index: number, _item: any) {
    return index
  }
